...
@testable import instructional
import XCTest

final class DependencyTests: XCTestCase {
    
    private static let dependencies = CoreServiceLocator {
        Register { WidgetModule() as WidgetModuleType }
        Register { SampleModule() as SampleModuleType }
        Register("abc") { SampleModule(value: "123") as SampleModuleType }
        Register { SomeClass() as SomeClassType }
    }
